...
while startornot == "Yes" or startornot == "yes" or  startornot == "1":
    ...
    while turns < 5:
        ...
        x = None
        while x == None:
        	x = space.numinput("Player 1","Enter the distance which you want your tank to tread ahead, max = {0}".format(maxmov),0,minval = 0,maxval = maxmov)
        #------------------------------------------------------Fd1--------------------------------------------------------------
        ...
        p = None
        while p == None:
        	p = space.numinput("Player 1","Enter the launch angle in degrees",45,minval = 0,maxval = 100)
        p = radians(p)
        u1a = None
        while u1a == None:
        ...
        y = None
        while y == None:
        	y = space.numinput("Player 2","Enter the distance which you want your tank to tread ahead max = {0}".format(maxmov),0,minval = 0,maxval = maxmov)
        y = -10*y
        targ2 = y
        b = -1
        ...
        q = None
        while q == None:
        	q = space.numinput("Player 2","Enter the launch angle in degrees",45,minval = 0,maxval = 100)
        q = radians(q)
        u2a = None
        while u2a == None:
